...
public class LockBenchmark_Random_PredominantRead_ReentrantLock_MediumLoad extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantRead_ReentrantLock_MediumLoad() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantRead_ReentrantLock_MediumLoad.class.getSimpleName())
                .forks(1)
