...
public class LockBenchmark_Random_PredominantRead_ReentrantLock_HighLoad_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantRead_ReentrantLock_HighLoad_SmallTasks() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantRead_ReentrantLock_HighLoad_SmallTasks.class.getSimpleName())
                .forks(1)
