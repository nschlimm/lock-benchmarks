...
public class LockBenchmark_Random_PredominantRead_ReentrantReadWriteLock_HighLoad extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantRead_ReentrantReadWriteLock_HighLoad() {
