...
public class LockBenchmark_Random_PredominantRead_ReentrantLock_LittleIdleTime extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantRead_ReentrantLock_LittleIdleTime() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_PredominantRead_ReentrantLock_LittleIdleTime.class.getSimpleName())
                .forks(1)
