...
public class LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch_SmallTasks() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch_SmallTasks.class.getSimpleName())
                .forks(1)
