...
public class LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_ReadOnly_ReentrantLock_LittleIdleBatch.class.getSimpleName())
                .forks(1)
