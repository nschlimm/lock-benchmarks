...
public class LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_LittleIdleBatch extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_LittleIdleBatch() {
