...
public class LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_MediumLoad_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_MediumLoad_SmallTasks() {
