...
public class LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_HighLoad_SmallTasks extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantReadWriteLock_HighLoad_SmallTasks() {
