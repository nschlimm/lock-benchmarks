...
public class LockBenchmark_Random_ReadOnly_ReentrantLock_HighLoad extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_ReadOnly_ReentrantLock_HighLoad() {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(LockBenchmark_Random_ReadOnly_ReentrantLock_HighLoad.class.getSimpleName())
                .forks(1)
