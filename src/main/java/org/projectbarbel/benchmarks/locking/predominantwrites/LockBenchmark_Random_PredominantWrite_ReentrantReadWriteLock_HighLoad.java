...
public class LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_HighLoad extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_HighLoad() {
