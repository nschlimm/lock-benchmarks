...
public class LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_MediumLoad extends LockTestHarness {

    @SuppressWarnings("unchecked")
    public LockBenchmark_Random_PredominantWrite_ReentrantReadWriteLock_MediumLoad() {
